...
path_to_origin = "C:\Program Files\OriginLab\Origin 2018\Origin95.exe"
# designate name of internal Origin script to run when origin opens
# this should be located in Origin User Files folder
internal_origin_script = 'C:\\Users\\a6q\\Documents\\OriginLab\\User Files\\internal_imes_script.py'
# path to data_folder
