"""
Run this script to analyze and fit raw QCM data from IMES software.
Change the folder name in line 8 to point toward the folder with the
raw IMES data. The results will be in hte variable named "results_df".
"""

# %% designate data folder name
data_folder_name = 'C:\\Users\\a6q\\exp_data\\2019-12-04_PS-old-h2o'
...
qcm_spec_files = [f for f in filelist if 'qcm_n=' in f]
...
times -= times[0]
times = np.linspace(0, times[-1], num=tot_spec_num) / 60
...
print('Analyzed results are in "results_df" varible.')